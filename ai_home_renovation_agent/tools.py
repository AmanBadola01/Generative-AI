...
class GenerateRenovationRenderingInput(BaseModel):
    ...
    current_room_photo: str = Field(description="Optional: filename of the current room photo to use as reference for layout/structure.")
    inspiration_image: str = Field(description="Optional: filename of an inspiration image to guide the style. Use 'latest' for most recent upload.")


class EditRenovationRenderingInput(BaseModel):
    artifact_filename: str = Field(description="The filename of the rendering artifact to edit. If not provided, uses the last generated rendering.")
    ...
    asset_name: str = Field(description="Optional: specify asset name for the new version (defaults to incrementing current asset).")
    reference_image_filename: str = Field(description="Optional: filename of a reference image to guide the edit. Use 'latest' for most recent upload.")
